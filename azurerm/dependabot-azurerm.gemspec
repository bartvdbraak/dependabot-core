...
Gem::Specification.new do |spec|
  ...
  spec.name         = "dependabot-azurerm"
  spec.summary      = "Provides Dependabot support for AzureRM"
  spec.description  = "Dependabot-AzureRM provides support for bumping AzureRM modules via Dependabot. " \
